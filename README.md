...
- **Queues** — cross-collection worklists unioning pipeline ownership, Tasks, and Approvals; stat strip, scope tabs, Table/Kanban views with transition-on-drop, claim/release
