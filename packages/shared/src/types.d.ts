...
export type FormFieldType = 'text' | 'textarea' | 'integer' | 'float' | 'decimal' | 'boolean' | 'date' | 'datetime' | 'select' | 'radio' | 'checkbox-group' | 'relation-m2o' | 'relation-o2m' | 'relation-m2m' | 'wysiwyg' | 'file' | 'json' | 'uuid' | 'unknown';
