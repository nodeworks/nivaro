  ...
  app.get('/', { preHandler: authenticate }, async (req, reply) => {
    ...
    let q = db('nivaro_collection_layouts')
      ...
      .select(
        ...
        'record_conditions', 'default_values', 'display_mode', 'hide_integrity_banner', 'hide_sla_banner'
      )
